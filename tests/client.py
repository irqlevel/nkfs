...
from tests_lib.settings import DS_CLIENT, DS_CTL
import tempfile
import os
import inspect
import hashlib
...
class DsClient:
	...
	def cli_cmd(self, cmd):
		return DS_CLIENT + " " + cmd + " " + self.srv_args()
...
if __name__=="__main__":
	...
	oid = c.put_file("bin/ds.ko")
	for d in devs:
		c.query_dev(d)

	c.get_file(oid, "ds_copy.ko")
