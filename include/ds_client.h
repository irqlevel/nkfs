...
int  ds_put_object(struct con_handle *con,struct ds_obj_id *obj_id,char *data, uint64_t data_size);
int  ds_get_object(struct con_handle *con,struct ds_obj_id *obj_id,char *data, uint64_t data_size);
